...
export function QuestionCard({ content, type, options, onAnswer }: QuestionCardProps) {
    ...
    return (
        <div className="w-full max-w-2xl bg-zinc-950 border border-zinc-800 rounded-xl p-8 shadow-2xl">
            ...
            <div className="mb-8 text-lg leading-relaxed text-zinc-200">
            ...
            <div className="space-y-4">
                {type === 'multiple_choice' && options?.map((opt, idx) => (
                    ...
                    >
                        <span className="w-8 h-8 flex items-center justify-center rounded-full bg-zinc-900 text-zinc-500 border border-zinc-700 mr-4 group-hover:bg-blue-500/20 group-hover:text-blue-400 group-hover:border-blue-500/50 flex-shrink-0">
