    ...
    return (
        <>
            ...
            >
                ...
                <nav className="absolute left-1/2 -translate-x-1/2 pointer-events-auto hidden md:flex items-center gap-1 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md px-2 py-2 rounded-full border border-black/5 dark:border-white/10 shadow-sm">
