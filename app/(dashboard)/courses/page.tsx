...
export default async function CoursesPage() {
    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-white transition-colors">
            {/* Background */}
            <div className="fixed inset-0 bg-gradient-to-br from-blue-100/50 via-transparent to-purple-100/50 dark:from-blue-900/10 dark:via-black dark:to-purple-900/10 pointer-events-none"></div>
