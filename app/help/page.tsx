        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 py-12">
                ...
                >
                    ...
                    <p className="text-zinc-400 mb-8">Search our knowledge base or browse categories</p>
                    ...
                    <div className="max-w-xl mx-auto relative">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-4 py-4 bg-zinc-900 border border-zinc-800 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-lg"
                        />
                    </div>
                </motion.div>
                ...
                >
                    <Link
                        href="/help/faq"
                        className="flex flex-col items-center p-6 bg-zinc-900/80 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all group"
                    >
                        <HelpCircle className="w-8 h-8 text-blue-400 mb-3" />
                        <span className="font-medium group-hover:text-blue-400 transition-colors">FAQ</span>
                    </Link>
                    <Link
                        href="/help/tutorials"
                        className="flex flex-col items-center p-6 bg-zinc-900/80 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all group"
                    >
                        ...
                        <span className="font-medium group-hover:text-green-400 transition-colors">Tutorials</span>
                    </Link>
                    <Link
                        href="/help/contact"
                        className="flex flex-col items-center p-6 bg-zinc-900/80 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all group"
                    >
                        ...
                        <span className="font-medium group-hover:text-purple-400 transition-colors">Contact</span>
                    </Link>
                    <Link
                        href="/help/feedback"
                        className="flex flex-col items-center p-6 bg-zinc-900/80 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all group"
                    >
                        ...
                        <span className="font-medium group-hover:text-yellow-400 transition-colors">Feedback</span>
                    </Link>
                </motion.div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {helpCategories.map((category, i) => (
                            <Link
                                ...
                                className="flex items-center gap-4 p-5 bg-zinc-900/80 border border-zinc-800 rounded-2xl hover:border-zinc-700 transition-all group"
                            >
                    ...
                    <div className="bg-zinc-900/80 border border-zinc-800 rounded-2xl overflow-hidden">
                        {popularArticles.map((article, i) => (
                            <Link
                                ...
                                className={`flex items-center justify-between p-4 hover:bg-zinc-800/50 transition-all ${i !== popularArticles.length - 1 ? 'border-b border-zinc-800' : ''
                                    }`}
                            >
                ...
                <motion.div
                    ...
                    className="text-center p-8 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-2xl"
                >
                    <Mail className="w-12 h-12 text-blue-400 mx-auto mb-4" />
                    <h3 className="text-xl font-bold mb-2">Can't find what you're looking for?</h3>
                    <p className="text-zinc-400 mb-6">Our support team is happy to help you</p>
                    <Link
                        href="/help/contact"
