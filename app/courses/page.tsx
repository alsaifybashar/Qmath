        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 py-12">
                    ...
                    {courses.map((course, i) => (
                        ...
                        >
                            <Link
                                ...
                                className={`block bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-2xl p-6 hover:border-zinc-700 transition-all group ${course.status === 'locked' ? 'opacity-60 cursor-not-allowed' : ''
                                    }`}
                            >
                                {/* Course Header */}
                ...
                >
                    <Link
                        href="/courses/browse"
                        className="inline-flex items-center gap-2 px-8 py-4 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-xl font-semibold transition-all"
                    >
                        Browse All Courses
